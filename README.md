...
| Skill | วัตถุประสงค์ |
|---|---|
| `plan-project` | ช่วยนักพัฒนาวางแผนไอเดียแอปผ่านการสนทนา และสร้าง `masterplan.md` |
| `gather-req` | เก็บรวบรวม Business และ Technical Requirements จาก Stakeholders อย่างเป็นระบบ |
| `spec-system` | แปลง Business Needs เป็น Functional และ Technical System Requirements |
| `survey-arch` | เก็บข้อมูล IT Infrastructure, Application Architecture เพื่อวาง Enterprise Architecture |
| `design-db` | ออกแบบ Database Schema สำหรับ PostgreSQL และ Laravel พร้อม Migration-ready guidance |
...
| Skill | วัตถุประสงค์ |
|---|---|
| `mentor-english` | ครู English ส่วนตัว รองรับ 6 โหมด: แปล, ตรวจแกรมมา, คิดประโยคตอบกลับ, จำลองสถานการณ์, ปรับ tone, คลังคำศัพท์ |
