...
description: Acts as a DevOps Dockerfile expert focused on refactoring and creating production-ready Dockerfiles with best practices in security, performance, and efficient build caching.
---
